                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="number" class="form-control @error('duration_minutes') is-invalid @enderror"
                               id="duration_minutes" name="duration_minutes" value="{{ old('duration_minutes', $exam->duration_minutes) }}" min="5" max="300" required>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <select class="form-select @error('grade') is-invalid @enderror"
                            ...
                            <option value="X" {{ old('grade', $exam->grade) == 'X' ? 'selected' : '' }}>X</option>
                            <option value="XI" {{ old('grade', $exam->grade) == 'XI' ? 'selected' : '' }}>XI</option>
                            <option value="XII" {{ old('grade', $exam->grade) == 'XII' ? 'selected' : '' }}>XII</option>
                        </select>
                        @error('grade')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select class="form-select @error('semester') is-invalid @enderror"
                            ...
                            <option value="gasal" {{ old('semester', $exam->semester) == 'gasal' ? 'selected' : '' }}>Gasal</option>
                            <option value="genap" {{ old('semester', $exam->semester) == 'genap' ? 'selected' : '' }}>Genap</option>
                        </select>
                        @error('semester')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">
                    ...
                    Pilih Soal ({{ $selectedQuestions->count() }} soal dipilih)
                </h6>
            </div>
            <div class="card-body">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Load currently selected questions
...
function displayQuestions(questions, preSelectedIds = []) {
    ...
    questions.forEach(question => {
        const isChecked = preSelectedIds.includes(question.id) ? 'checked' : '';
        html += `<tr>
            <td><input type="checkbox" name="questions[]" value="${question.id}" class="question-checkbox" ${isChecked}></td>
