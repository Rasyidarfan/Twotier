                ...
                <div class="col-lg-8">
                    ...
                    <div class="card mb-4">
                        <div class="card-body text-center">
                            ...
                            <p class="text-muted mb-0">{{ $exam->subject->name }} • {{ $exam->grade }} •
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="alert alert-info">
                                    ...
                                    <strong>Status:</strong> Identitas berhasil tersimpan. Anda sudah berada dalam waiting room
                                    ujian.
                                    <br><small>Tunggu guru memulai ujian atau memberikan persetujuan jika ujian sudah
                                        dimulai.</small>
                                </div>
                                ...
                                <form method="POST" action="{{ route('exam.submit-identity', $session) }}">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            <label for="student_name" class="form-label">Nama Lengkap <span
                                                    class="text-danger">*</span></label>
                                            <input type="text" class="form-control text-uppercase @error('student_name') is-invalid @enderror"
                                                id="student_name" name="student_name"
                                                value="{{ old('student_name', $session->student_name) }}"
                                                placeholder="Masukkan nama lengkap Anda" maxlength="255" required>
                                            @error('student_name')
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <label for="student_identifier" class="form-label">Nomor Induk/NIS
                                                (Opsional)</label>
                                            <input type="text"
                                                class="form-control text-uppercase @error('student_identifier') is-invalid @enderror"
                                                id="student_identifier" name="student_identifier"
                                                value="{{ old('student_identifier', $session->student_identifier) }}"
                                                placeholder="Masukkan NIS atau nomor identitas" maxlength="255">
                    ...
                    <!-- Other Participants | siswa terlambat bisa memilih card untuk bergabung kembali -->
                    @if($otherParticipants->count() > 0)
                        <div class="card mt-4">
                            <div class="card-header">
                                ...
                                <small class="text-muted">Apakah Anda salah satu dari peserta ini? Klik untuk melanjutkan sesi Anda.</small>
                            </div>
                            <div class="card-body">
                                        ...
                                        <div class="card-body p-3">
                                            <div class="d-flex align-items-center justify-content-between">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        ...
                                                        @if($participant->student_identifier)
                                                            <small class="text-muted">NIS: {{ $participant->student_identifier }}</small>
                                                        @endif
                                                        <div>
                                                            <small class="
                                                                {{ $participant->status === 'in_progress' ? 'text-success' :
                                                                   ($participant->status === 'approved' ? 'text-info' : 'text-warning') }}">
                                                                <i class="fas fa-circle"></i> {{ $participant->status_display }}
                                                            </small>
                                                        </div>
                                                    </div>
                                                </div>
                                                <form method="POST" action="{{ route('exam.select-existing', $session) }}" class="d-inline">
                                                    @csrf
                                                    <input type="hidden" name="existing_session_id" value="{{ $participant->id }}">
